<template>
    ...
    <div class="row mt-2 mx-auto fakeKpList d-block">
							...
							<!-- w4 -->
								<div class="col-3 px-1">
									<div class="roundedz bg-darkz text-white px-0">
										...
										<div class="row py-2 px-4">
										<div class="col-lg-3 col-md-6 px-1 kpw4b1" @click="w4b1Click"><img src="https://wiki.guildwars2.com/images/6/63/Cairn_the_Indomitable_Shard.png" class="w-100"></div>
										<div class="col-lg-3 col-md-6 px-1 kpw4b2" @click="w4b2Click"><img src="https://wiki.guildwars2.com/images/f/f1/Rec_Room_Floor_Tile.png" class="w-100"></div>
										<div class="col-lg-3 col-md-6 px-1 kpw4b3" @click="w4b3Click"><img src="https://wiki.guildwars2.com/images/a/aa/Impaled_Prisoner.png" class="w-100"></div>
										<div class="col-lg-3 col-md-6 px-1 kpw4b4" @click="w4b4Click"><img src="https://wiki.guildwars2.com/images/c/cf/Fragment_of_Saul%27s_Burden.png" class="w-100"></div>
										</div>
									</div>
								</div>
						</div>
							...
							<!-- w5 -->
								<div class="col-3 px-1">
									<div class="roundedz bg-darkz text-white px-0">
										...
										<div class="row py-2 px-4">
										<div class="col-lg-3 col-md-6 px-1 kpw5b1" @click="w5b1Click"><img src="https://wiki.guildwars2.com/images/1/11/Desmina%27s_Token.png" class="w-100"></div>
										<div class="col-lg-3 col-md-6 px-1 kpw5b2  opacity-25"><img src="https://wiki.guildwars2.com/images/2/27/River_of_Souls_Token.png" class="w-100"></div>
										<div class="col-lg-3 col-md-6 px-1 kpw5b3  opacity-25"><img src="https://wiki.guildwars2.com/images/7/7d/Statue_of_Grenth_Token.png" class="w-100"></div>
										<div class="col-lg-3 col-md-6 px-1 kpw5b4" @click="w5b4Click"><img src="https://wiki.guildwars2.com/images/thumb/2/24/Dhuum%27s_Token.png/40px-Dhuum%27s_Token.png" class="w-100"></div>
										</div>
									</div>
								</div>
							<!-- w6 -->
								<div class="col-3 px-1">
									<div class="roundedz bg-darkz text-white px-0">
										...
										<div class="row py-2 px-4">
										<div class="col-lg-3 col-md-6 px-1 kpw6b1 opacity-25"><img src="https://wiki.guildwars2.com/images/c/c4/Conjured_Amalgamate_Token.png" class="w-100"></div>
										<div class="col-lg-3 col-md-6 px-1 kpw6b2 opacity-25"><img src="https://wiki.guildwars2.com/images/0/0a/Twin_Largos_Token.png" class="w-100"></div>
										<div class="col-lg-3 col-md-6 px-1 kpw6b3" @click="w6b3Click"><img src="https://wiki.guildwars2.com/images/b/ba/Qadim%27s_Token.png" class="w-100"></div>
										<div class="col-lg-3 col-md-6 px-1"></div>
										</div>
									</div>
								</div>
							<!-- w7 -->

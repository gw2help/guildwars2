       ...
       <div class="row">
        ...
        <div v-if="jsonz" class="row mx-1 mb-5">
            ...
            <div class="col-4 mb-3">
                ...
                <builder v-for="x in this.jsonz.revenant[0]"
                    class=""
                    :key="x"
                    :name="x.name"
                    :link="x.link"
            ...
            <div class="col-4 mb-3">
                ...
                <builder v-for="x in this.jsonz.engineer[0]"
                    class=""
                    :key="x"
                    :name="x.name"
                    :link="x.link"
            ...
            <div class="col-4 mb-3">
                ...
                <builder v-for="x in this.jsonz.ranger[0]"
                    class=""
                    :key="x"
                    :name="x.name"
                    :link="x.link"
            ...
            <div class="col-4 mb-3">
                ...
                <builder v-for="x in this.jsonz.mesmer[0]"
                    cclass=""
                    :key="x"
                    :name="x.name"
                    :link="x.link"
            ...
            <div class="col-4 mb-3">
                ...
                <builder v-for="x in this.jsonz.necromancer[0]"
                    class=""
                    :key="x"
                    :name="x.name"
                    :link="x.link"
            ...
            <div class="col-4 mb-3">
                ...
                <builder v-for="x in this.jsonz.thief[0]"
                    class=""
                    :key="x"
                    :name="x.name"
                    :link="x.link"
            ...
            <div class="col-4 mb-3">
                ...
                <builder v-for="x in this.jsonz.elementalist[0]"
                    class=""
                    :key="x"
                    :name="x.name"
                    :link="x.link"
            ...
            <div class="col-4 mb-3">
                ...
                <builder v-for="x in this.jsonz.warrior[0]"
                    class=""
                    :key="x"
                    :name="x.name"
                    :link="x.link"
